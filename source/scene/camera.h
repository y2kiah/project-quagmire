...
//	virtual void	getFarClipCoordinates(dvec3 *topLeft, dvec3 *topRight, dvec3 *bottomLeft, dvec3 *bottomRight);
	...
	void getFrustum(r32 *left, r32 *top, r32 *right, r32 *bottom, r32 *near, r32 *far);
...
//		//if (!inverseModelViewCached) { calcInverseModelView(); }
//	}
...
//
//	CameraPersp();
//	CameraPersp(int pixelWidth, int pixelHeight, r32 fov); // constructs screen-aligned camera
//	CameraPersp(int pixelWidth, int pixelHeight, r32 fov, r32 nearPlane, r32 farPlane); // constructs screen-aligned camera
//
//	void setPerspective(
...
class CameraPersp2 : public CameraPersp {
	...
	CameraPersp2(int pixelWidth, int pixelHeight, r32 fov, r32 nearPlane, r32 farPlane) :
	...
	void lookAt(const dvec3 &position, const dvec3 &target, const dvec3 &worldUp);
...
struct CameraOrtho : public Camera {
	CameraOrtho();
	CameraOrtho(r32 left, r32 right, r32 bottom, r32 top, r32 nearPlane, r32 farPlane);

	void setOrtho(r32 left, r32 right, r32 bottom, r32 top, r32 nearPlane, r32 farPlane);
